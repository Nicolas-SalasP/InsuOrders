                ...
                <div className="modal-content shadow border-0">
                    <div className="modal-header bg-success text-white">
                        <h5 className="modal-title fw-bold">
                            <i className="bi bi-box-arrow-in-down me-2"></i>Entrada / Ajuste (+)
                        </h5>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="modal-body p-4 text-center">
                            ...
                            <div className="form-floating mb-3">
                                <input type="number" className="form-control fs-2 text-center fw-bold text-success" 
                                    placeholder="0" required min="0.01" step="0.01" autoFocus
                                    value={cantidad} onChange={e => setCantidad(e.target.value)} />
                                <label>Cantidad a Sumar</label>
                            </div>
                            
                            <input type="text" className="form-control" placeholder="Motivo (Opcional)"
