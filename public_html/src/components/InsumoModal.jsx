...
const InsumoModal = ({ show, onClose, onSave, insumo }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Object.keys(formData).forEach(key => { if (key !== 'id') dataToSend.append(key, formData[key] ?? ''); });
                    ...
                    <div className="modal-content border-0 shadow-lg">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="modal-footer bg-light">
                                ...
                                <button type="submit" className="btn btn-primary px-4" disabled={saving}>{saving ? 'Guardando...' : 'Guardar'}</button>
                            </div>
                        </form>
                    </div>
                </div>
